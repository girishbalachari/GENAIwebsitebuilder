  ...
  const handleGoogleAuth = async () => {
    try {
      ...
      if (error.message?.includes("Cross-Origin-Opener-Policy")) {
        console.warn("Harmless COOP warning");
        return;
      }
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md p-[1px] rounded-3xl bg-linear-to-br from-purple-500/40 via-blue-500/30 to-transparent"
